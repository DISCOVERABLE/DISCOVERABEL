			...
			<div class="news">
				<article class="topContent">
					<?php
						...
						$getMessages = "SELECT * FROM MESSAGES WHERE TO_ = '"  . $USER_ID . "'";
						$result = mysql_query($getMessages);
						...
						echo('<header>
								<h2><a href="#" title="Error Occurred">Messages</a></h2>
							</header>
						...
						while ($row = mysql_fetch_array($result, MYSQL_NUM)) {
							if($row[4]){
								echo '<a class="project" href="message.php?m=' . $row[0] . '">
									<img src="imgs/standard_project_img.png" style="-webkit-filter: grayscale(1);
									filter: grayscale(1);">
									<div>
										<header style="color: #999;">'  . $row[5] . '</header>
